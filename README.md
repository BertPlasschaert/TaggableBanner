...
The SVG is ideal for this as its scales perfectly for every screen.
It is also a fairly nice interface to progamatically generate.
...
The github actions install the same package and call the same commands when an issue is opened.
